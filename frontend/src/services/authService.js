...
export const login = async (email, password) => {
    try {
        const userResponse = await axiosInstance.post('/api/student/login', { email, password });
...
export const register = async (userData) => {
    try {
        ...
        const response = await axiosInstance.post('/api/student/register', userData);
...
export const forgotPassword = async (email) => {
    try {
        const response = await axiosInstance.post('/api/student/forgot-password', { email });
        return response.data;
    } catch (error) {
...
export const resetPassword = async (email, code, newPassword) => {
    try {
        const response = await axiosInstance.post('/api/student/reset-password', { 
            email, 
            code, 
            newPassword 
        });
